...
function DisplayWeather({ currentForcast, dailyForcast, hourlyForcast}, radar) {
    ...
    const getTime = (time, formating) => {
        const timestamp = moment.tz((time * 1000), "America/Denver").format()
        return moment.tz(timestamp, "America/Denver").format(formating)
    }
    return (
        <div>
